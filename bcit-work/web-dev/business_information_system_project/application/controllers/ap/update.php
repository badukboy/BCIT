...
/**
 * controllers/ap/update.php
 * 
 * Controller the Accounts Payable/Vendors update item page.
 * 
 * @author Group DEF
 */
class Update extends Application 
{
    ...
    function index() 
    {
        ...
        // Form data
        $this -> data['update_form'] = $this -> parser -> parse('ap/_update_form',
                $this -> data, true);
        
        $this -> data['pagebody'] = 'ap/update';
        $this -> render();
    }
