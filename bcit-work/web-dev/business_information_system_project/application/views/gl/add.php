 ...
 * views/gl/add.php
 * 
 * Accounts add item view. Displays a simple form for database input.
 * 
 * @author Group DEF
 */
...
<div class="row-fluid">
    <div class="span2">
        <div class="well sidebar-nav">
            <ul class="nav nav-list">
                ...
                <li class="active"><a href="{url-add}"><i class="icon-plus"></i> Add</a></li>
    ...
    <div class="span10">
        ...
        <?php
            ...
            if(count($errors) > 0)
            {
                echo '<p><b>Warning! ' . count($errors) . ' error(s)!</b></p>';
